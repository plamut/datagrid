...
zahtevek za repliko, do trenutka, ko zahtevano repliko prejme. Če vozlišče
repliko že ima pri sebi, se smatra, da je odzivni čas enak nič -- čas samega
obdelovanja zahtevka se torej zanemari.
...
\small
  \begin{center}
    \begin{tabulary}{1.0\textwidth}{ >{}p{20em} J}
      ...
      Število generiranih zahtevkov & 100.000 \\
      Čas med prihodi zahtevkov vozlišč & med 0 in 99 s \\
      Število skupin replik & 10 \\
      Diskovni prostor na vozliščih (razen glavnega strežnika) & 50.000 Mbit \\
      ...
      Frequency specific time interval \TODO{prevod?} & 10.000 \\
      C1 & 0,001 \\
      C2 & 0,001
    \end{tabulary}
  \end{center}
...
povej, kakšen je communicaiton latency ... pa random seed ... pa topologija
(razdalje med vozlišči, kakšno drevo dobiš) - mogoče v prilogi?


The inter-arrival times of nodes’ requests and replicas’ sizes
follow uniform distribution.
čas za zamenjavo rpelik je zanemarljivo majhen (nič)
