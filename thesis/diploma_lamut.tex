...
\begin{center}
\textbf{\large{Primerjava dveh strategij dinamične replikacije}}
\end{center}
Primerjajte strategiji EFS (Enhanced Fast Spread) in MFS (Modified Fast Spread)
za dinamično replikacijo v podatkovnih omrežjih.  Opisani sta v dveh izredno
podobnih znanstvenih člankih, ki zaradi istih avtorjev in podobnosti besedila
že mejita na avtoplagiatorstvo.  Poskusite ponoviti njihove meritve in
ugotovite, v kolikšni meri se ti dve strategiji razlikujeta med seboj.

\vskip 10em%

\begin{center}
\textbf{\large{Comparison of two dynamic data replication strategies}}
\end{center}
Compare EFS (Enhanced Fast Spread) and MFS (Modified Fast Spread), two dynamic
data replication strategies. These two strategies have been described in two
scientific papers that exhibit a strong indication of autoplagiarism as they
are written by the same authors and share a significant portion of the content.
Repeat the experiments described in both papers and find out how much these two
...
sta strategiji opisani? kot vir pač, od kod psevdokoda}
...
dogodki v simulaciji in sámo izvajalno okolje simulacije.
