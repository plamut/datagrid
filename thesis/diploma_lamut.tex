...
\begin{algorithm}[H]
  \label{alg:EFS}
  \caption{Algoritem EFS (\TODO{preimenuj bold oznako + referenca na članek})}
...
Pomen posameznih spremenljivk v algoritmu XYZ prikazuje tabela XYZ
...
\small
  \begin{center}
    \begin{tabulary}{1.0\textwidth}{ >{\itshape}p{7em} J}
      ...
      NSPList & seznam vozlišča na najkrajši poti od \textit{RN} do
          glavnega strežnika \\
...
\begin{algorithm}[H]
  \label{alg:MFS}
  \caption{Algoritem MFS (\TODO{preimenuj bold oznako + referenca na članek})}
