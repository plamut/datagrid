...
informatiko ter mentorja.}% TODO: morda pa res raje izdaj pod katero izmed prostih licenc?
...
\vspace{1cm}
% TODO: pravi datum!
\noindent V Ljubljani, dne 1. aprila 2014 \hfill Podpis avtorja:
...
TODO: uvod - vse naj bo na kratko, da ``pritegne bralca''


\section{Nekaj o datagridih}

TODO: slovenski términ? (podatkovne mreže?)
Kaj so to, kako delujejo, 
Kaj je problem? razporediti replike tako, da je čim manj pasovne širine
porabljeno in d aje odzivni čas čim manji

TODO: sklicevanje na vire

TODO: še kakšna slika (nariši npr. z LaTeXom - kar tako, za vajo)

\section{Replikacija podatkov v datagridih}
Način, kako repliciramo podatke v omrežju
...
- copy-paste (kako so si podobni ... tega zato zgoraj v uvodu ne pišeš, tam
le omeniš "sum plagiatorstva", tu pa potem razdelaš)

- meritve se ne ujemajo
Povej, zakaj ... kje je spodnja meja ... kritiziraj metrike ...

- problemi: nejasnosti, slaba metrika (razdelaj), nappake v algoritmih,
...
% TODO: naj se to prikaže v kazalu! ("Literatura")
