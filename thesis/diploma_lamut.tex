...
\begin{tikzpicture}[scale=1.2]
  \begin{axis}[
    ...
    \addplot[fill=gray!40] coordinates {  % LRU
      (1, 55910.66) (2, 41550.05) (3, 25356.10)
    };
    \addplot[fill=gray] coordinates {  % LFU  
      (1, 41760.98) (2, 28372.55) (3, 16949.96)
    };
    \addplot[fill=black] coordinates {  % EFS 
      (1, 53383.87) (2, 39236.63) (3, 24393.25)
    };    
...
\begin{tikzpicture}[scale=1.2]
  \begin{axis}[
    ...
    \addplot[fill=gray!40] coordinates {  % LRU
      (1, 116780.38) (2, 114216.31) (3, 108200.84)
    };
    \addplot[fill=gray] coordinates {  % LFU  
      (1, 114953.38) (2, 109710.82) (3, 98400.73)
    };
    \addplot[fill=black] coordinates {  % EFS 
      (1, 116574.68) (2, 113760.48) (3, 107298.33)
    };    
    \addplot[fill=white] coordinates {  % MFS
      (1, 116574.68) (2, 113760.48) (3, 107298.33)
    };
