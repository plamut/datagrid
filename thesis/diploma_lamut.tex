...
\subsection{Pomanjkljivosti v opisih strategij (psevdokoda)}
...
(tukaj komentar, da to sicer ni "napaka", kaže pa na površnost.
... oziroma ne, je napaka (ampak tega ne omenjaj), povej pač, da gre za
površnost
v opisu piše, da jo zahteva od starša, dokler je ne najde, tukaj pa gre vse
do glavnega strežnika.

"3. Na koncu if-a v vrstici 6 manjka en "break"? Namreč če repliko na poti do
strežnika že nekje najdemo in jo pripeljemo navzdol, nima več smisla, da
nadaljujemo tisti "for i = 2 ..." iz vrstice 5.
Skratka ne gledamo več po hierarhiji navzgor, ker smo vmes na poti že našli "bolj
lokalno" kopijo replike in nas ne zanima, ali se replika morda nahaja še kje nad
tem."
...
ki bi tekla na vsakem vozlišču... da sem v simulaciji napravil tako


\subsection{Vprašljiva zasnova simulacije}

- pa a je topologija sploh realna? v praksi vozlišča načeloma lahko
 zahtevajo replike tudi po drugih poteh, če je ena zasedena... pa redundanca
 recimo zdaj, če eno vozlišče pade, celo vejo odreže, ker je najkrajša pot do
 strežnika statična, se ne spreminja glede na (ne)dosegljivost vozlišč in
 obremenitve posameznih vozlišč.
\TODO{vstavi sliko, da se bolje vidi drevesna struktura
... morda naredi kar vektorsko? - če bo čas}

Ni realna struktura in routing, zelo dominira čas prenosa po mreži (na odzivni
čas vpliva) in je latenca brezveze (?), mreža se zabaše ... prevleik vpliv
teh ozkih grl?

- morda lagoritem ne konvergira? vsaka replika od vozlišča zahtevana zgolj
nekajkrat ...

- pa med čakanjem na repliko ... a jo spet zahtevamo? strogo po algoritmu da,
čeprav je to neesmisel (morda tole pod kakšno drugo točko, ampak vseeno omeni)
